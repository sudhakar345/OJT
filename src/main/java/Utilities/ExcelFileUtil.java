...
public class ExcelFileUtil {
	...
	{
	 FileInputStream fis=new FileInputStream("D:\\Sudhakar\\ERP_Maven\\TestInput\\InputSheet.xlsx");
...
FileOutputStream fos=new FileOutputStream("D:\\Sudhakar\\ERP_Maven\\TestOutput\\maven.xlsx");
wb.write(fos);
fos.close();
}
}
