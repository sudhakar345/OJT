...
{
	System.out.println("Unable execute typesction method");
}
}
...
FileWriter fr=new FileWriter("D:\\Sudhakar\\ERP_Maven\\CaptureData\\supplier.txt");
BufferedWriter bw=new BufferedWriter(fr);
bw.write(supplierdata);
bw.flush();
bw.close();
}
//table  validation for suppiler creation
public static void tableValidation(WebDriver driver,String column) throws Throwable
{
	FileReader fr=new FileReader("D:\\Sudhakar\\ERP_Maven\\CaptureData\\supplier.txt");
...
{	
String Act_data=driver.findElement(By.xpath("//table[@id='tbl_a_suppilerslist']/tbody/tr["+i+"]/td["+column1+"]/div/span/span")).getText();
Thread.sleep(5000);
Assert.assertEquals(Exp_data, Act_data,"suppier number is not maching");
